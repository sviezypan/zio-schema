...
```scala
libraryDependencies += "dev.zio" %% "zio-schema"          % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-avro"     % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-bson"     % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-msg-pack" % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-thrift"   % "0.1.8"
libraryDependencies += "dev.zio" %% "zio-schema-zio-test" % "0.1.8"

// Required for the automatic generic derivation of schemas
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "0.1.8"
